## This is the solution for the leave problems
...
# Instruction code foe isubl instruction
...
intsig ALUSUB   'A_SUB'		# ALI should sub its arguments
...
int aluB = [
	icode in { IRMMOVL, IMRMOVL, IOPL, ICALL, 
		      IPUSHL, IRET, IPOPL, IIADDL, IISUBL } : valB;
